...
public class ReceiverShipmentListiningDto {
    ...
    public ReceiverShipmentListiningDto(@NotBlank(message = "Tracking number is required") @Size(max = 50, message = "Tracking number must be max 50 characters") String trackingNumber, @NotNull(message = "Status code is required") ShipmentLifecycleStatus shipmentLifecycleStatus, LocalDateTime estimateDeliveryDate, Boolean isPaid) {
