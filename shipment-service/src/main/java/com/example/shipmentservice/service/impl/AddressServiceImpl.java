...
public class AddressServiceImpl implements AddressService {
    ...
    public Address findById(UUID id) {
        return addressRepository.findById(id).orElseThrow(()-> new RuntimeException(ADDRESS_NOT_FOUND+id));
    }
    ...
    public Address update(UpdateAddressDto updateAddressDto) {
        Address address=addressRepository.findById(updateAddressDto.getId()) .orElseThrow(() -> new RuntimeException(ADDRESS_NOT_FOUND));
    ...
    public void delete(DeleteAddressDto deleteAddressDto) {
        Address address=addressRepository.findById(deleteAddressDto.getId()).orElseThrow(()-> new RuntimeException(ADDRESS_NOT_FOUND));
